...
@Builder
@Schema(description = "식품영양정보 생성을 위한 요청")
public record FoodCreateRequest(
    @Schema(description = "SAMPLE_ID", example = "D000006-94-AVG") @NotNull(message = "SAMPLE ID를 입력해주세요.") String sampleId,
    @Schema(description = "식품코드", example = "D000006") @NotNull(message = "식품코드를 입력해주세요.") String foodCode,
    @Schema(description = "DB군", example = "음식") @NotNull(message = "DB군을 입력해주세요.") String dbGroup,
    @Schema(description = "상용제품", example = "품목대표") @NotNull(message = "상용제품을 입력해주세요.") String product,
    @Schema(description = "식품명", example = "꿩불고기") @NotNull(message = "식품명을 입력해주세요.") String foodName,
    @Schema(description = "연도", example = "2019") @NotNull(message = "연도를 입력해주세요.") String researchYear,
    @Schema(description = "지역 / 제조사", example = "충주") @NotNull(message = "지역/제조사를 입력해주세요.") String makerName,
    @Schema(description = "채취시기", example = "평균") @NotNull(message = "채취시기를 입력해주세요.") String collectionTime,
    @Schema(description = "식품대분류", example = "구이류") @NotNull(message = "식품대분류를 입력해주세요.") String foodGroup,
    @Schema(description = "식품상세분류", example = "육류구이") @NotNull(message = "식품상세분류를 입력해주세요.") String groupName,
    @Schema(description = "1회제공량", example = "500") @NotNull(message = "1회제공량을 입력해주세요.") String servingSize,
    @Schema(description = "내용량_단위", example = "g") @NotNull(message = "내용량 단위를 입력해주세요.") String servingSizeUnit,
    @Schema(description = "성분표출처", example = "외식영양성분자료집 통합본(2012-2017년)") @NotNull(message = "성분표출처를 입력해주세요.") String refName,
    @Schema(description = "발행기관", example = "식품의약품안전처") @NotNull(message = "발행기관을 입력해주세요.") String organization,
